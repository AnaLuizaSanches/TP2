...
public class Main {                
    ...
    public static void preCadastros(){
        ...
        //VicePrefeitos
        VicePrefeito vp1 = new VicePrefeito("01", "JoseAlves", "JA@gmail.com", Data.getDate("01/02/1980"), pt2);
        VicePrefeito.lista.add(vp1);
        VicePrefeito vp2 = new VicePrefeito("02", "LuisaBorges", "LB@live.com", Data.getDate("13/09/1970"), pt2);
        VicePrefeito.lista.add(vp2);
        VicePrefeito vp3 = new VicePrefeito("03", "ClaudioManoel", "CM@hotmail.com", Data.getDate("11/12/1990"), pt3);
        VicePrefeito.lista.add(vp3);
        
        //Prefeitos
        Prefeito p1 = new Prefeito(vp1, "01", "AndreLegal", "AL@hotmail.com", Data.getDate("07/06/1997"), pt1);
        Prefeito.lista.add(p1);
        Prefeito p2 = new Prefeito(vp2, "02", "AnaJoia", "AJ@gmail.com", Data.getDate("14/08/1995"), pt1);
        Prefeito.lista.add(p2);
        Prefeito p3 = new Prefeito(vp3, "03", "PrMconnagit", "PM@hotmail.com", Data.getDate("12/11/1950"), pt1);
